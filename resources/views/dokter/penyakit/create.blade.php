    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control"id="deskripsi" cols="10" rows="8"></textarea>
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <textarea name="solusi" class="form-control" id="solusi" cols="10" rows="8"></textarea>
